      ...
      <>
        <Offcanvas show={this.props.showOffcanvas} onHide={this.props.handleClose} key='end' placement='end' name='end'>
          ...
          <Offcanvas.Body>
            {
              this.props.itemCurrentlyBeingEdited ?
              <EditItemForm handleClose={this.props.handleClose} categories={this.props.categories} createCategory={this.props.createCategory} getItems={this.props.getItems} itemCurrentlyBeingEdited={this.props.itemCurrentlyBeingEdited} editItem={this.props.editItem}/>
              :
